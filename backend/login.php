...
<html lang="en" class="perfect-scrollbar-on"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- <link href="./Material Dashboard PRO by Creative Tim _ Premium Bootstrap Admin Template_files/demo.css" rel="stylesheet"> -->
    <!--     Fonts and icons     -->
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a href="http://www.creative-tim.com/">Creative by</a>, ozaman
                    </p>
                </div>
            </footer>
        <div class="full-page-background" style="background-image: url(images/login.jpeg) "></div></div>
    </div>
...
<!-- Select Plugin -->
<!-- <script src="./jquery.select-bootstrap.js"></script> -->
...
<script src="js/angular/login.js?v=<?=time()?>"></script>
<!-- Material Dashboard DEMO methods, don't include it in your project! -->
