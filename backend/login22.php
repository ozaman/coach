...
<head>
<meta charset="utf-8"/>
<title>Imron Phuket Speedboat tours. </title>
...
<link href="css/login-soft.css?v=<?=time()?>" rel="stylesheet" type="text/css"/>
...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login" ng-app="myApp" ng-controller="Login">
<!-- BEGIN LOGO -->
<div class="logo">
	<a href="index.html">
	<span>IMRON <span style="color: #ff3f3f">TOURS</span></span>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<!-- <form class="login-form" > -->
		...
		<div id="message" align="center" style="padding: 10px"></div>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2017 &copy; Ozaman - Admin Dashboard Template.
</div>
<!-- END COPYRIGHT -->
